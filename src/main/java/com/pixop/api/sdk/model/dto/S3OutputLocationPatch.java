 ...
 */
@JsonPropertyOrder({
  S3OutputLocationPatch.JSON_PROPERTY_BUCKET,
  S3OutputLocationPatch.JSON_PROPERTY_ACCESS_KEY,
  S3OutputLocationPatch.JSON_PROPERTY_SECRET_ACCESS_KEY,
  S3OutputLocationPatch.JSON_PROPERTY_NAME
})
