...
public class Account {
  ...
  public static final String SERIALIZED_NAME_DEFAULT_TEAM = "defaultTeam";
  @SerializedName(SERIALIZED_NAME_DEFAULT_TEAM)
  @javax.annotation.Nullable
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      // validate the optional field `defaultTeam`
      if (jsonObj.get("defaultTeam") != null && !jsonObj.get("defaultTeam").isJsonNull()) {
        Team.validateJsonElement(jsonObj.get("defaultTeam"));
      }
  }
