 ...
 */
@JsonPropertyOrder({
  S3OutputLocation.JSON_PROPERTY_ID,
  S3OutputLocation.JSON_PROPERTY_CREATED_AT,
  S3OutputLocation.JSON_PROPERTY_UPDATED_AT,
  S3OutputLocation.JSON_PROPERTY_NAME,
  S3OutputLocation.JSON_PROPERTY_BUCKET,
  S3OutputLocation.JSON_PROPERTY_ACCESS_KEY_HIDDEN,
  S3OutputLocation.JSON_PROPERTY_SECRET_ACCESS_KEY_HIDDEN
})
