 ...
 */
@JsonPropertyOrder({
  ApiKeysPage.JSON_PROPERTY_PAGE_NUMBER,
  ApiKeysPage.JSON_PROPERTY_PAGE_SIZE,
  ApiKeysPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  ApiKeysPage.JSON_PROPERTY_TOTAL_PAGES,
  ApiKeysPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  ApiKeysPage.JSON_PROPERTY_ITEMS
})
...
public class ApiKeysPage {
  ...
  public ApiKeysPage items(@javax.annotation.Nonnull List<ApiKey> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<ApiKey> items) {
    this.items = items;
  }
