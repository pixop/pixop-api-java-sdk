...
import com.pixop.api.sdk.model.dto.VideoProcessingConfigurationOptionsFilterSettingsPrescaledResolution;
...
@JsonPropertyOrder({
  ...
  VideoProcessingConfigurationOptionsFilterSettings.JSON_PROPERTY_PRESCALED_RESOLUTION,
...
public class VideoProcessingConfigurationOptionsFilterSettings {
  ...
  public static final String JSON_PROPERTY_PRESCALED_RESOLUTION = "prescaledResolution";
  @javax.annotation.Nullable
  private VideoProcessingConfigurationOptionsFilterSettingsPrescaledResolution prescaledResolution;
  ...
  public VideoProcessingConfigurationOptionsFilterSettings prescaledResolution(@javax.annotation.Nullable VideoProcessingConfigurationOptionsFilterSettingsPrescaledResolution prescaledResolution) {
    
    this.prescaledResolution = prescaledResolution;
    return this;
  }

  /**
   * Get prescaledResolution
   * @return prescaledResolution
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PRESCALED_RESOLUTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public VideoProcessingConfigurationOptionsFilterSettingsPrescaledResolution getPrescaledResolution() {
    return prescaledResolution;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PRESCALED_RESOLUTION)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPrescaledResolution(@javax.annotation.Nullable VideoProcessingConfigurationOptionsFilterSettingsPrescaledResolution prescaledResolution) {
    this.prescaledResolution = prescaledResolution;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.interlacedFieldOrderMode, videoProcessingConfigurationOptionsFilterSettings.interlacedFieldOrderMode) &&
        ...
        Objects.equals(this.prescaledResolution, videoProcessingConfigurationOptionsFilterSettings.prescaledResolution) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(interlacedFieldOrderMode, normalizedCropCoordinates, cropRectangle, prescaledResolution, faceForward, dvres2Variant, clarityBoost, resolution, frameRate, filmGrain);
  }
  ...
  public String toString() {
    ...
    sb.append("    prescaledResolution: ").append(toIndentedString(prescaledResolution)).append("\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `prescaledResolution` to the URL query string
    if (getPrescaledResolution() != null) {
      joiner.add(getPrescaledResolution().toUrlQueryString(prefix + "prescaledResolution" + suffix));
    }
