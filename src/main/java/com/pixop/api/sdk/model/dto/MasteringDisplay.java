...
/**
 * Represents the SMPTE ST 2086 metadata of a mastering display, describing the display&#39;s color volume and luminance characteristics.  This metadata defines the primary color chromaticities, white point, and luminance levels for High Dynamic Range (HDR) content mastering. 
 */
...
public class MasteringDisplay {
  ...
  @javax.annotation.Nullable
  private BigDecimal minLuminance;
  ...
  /**
   * The maximum luminance level of the mastering display, measured in cd/m² (nits).  This defines the brightest level the display can achieve. 
   * minimum: 0.0
   * maximum: 10000.0
   * @return maxLuminance
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.red, masteringDisplay.red) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(red, green, blue, whitePoint, minLuminance, maxLuminance);
  }
