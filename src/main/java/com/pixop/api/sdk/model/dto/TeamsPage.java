 ...
 */
@JsonPropertyOrder({
  TeamsPage.JSON_PROPERTY_PAGE_NUMBER,
  TeamsPage.JSON_PROPERTY_PAGE_SIZE,
  TeamsPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  TeamsPage.JSON_PROPERTY_TOTAL_PAGES,
  TeamsPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  TeamsPage.JSON_PROPERTY_ITEMS
})
...
public class TeamsPage {
  ...
  public TeamsPage items(@javax.annotation.Nonnull List<Team> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<Team> items) {
    this.items = items;
  }
