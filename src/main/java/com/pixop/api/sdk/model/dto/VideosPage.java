 ...
 */
@JsonPropertyOrder({
  VideosPage.JSON_PROPERTY_PAGE_NUMBER,
  VideosPage.JSON_PROPERTY_PAGE_SIZE,
  VideosPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  VideosPage.JSON_PROPERTY_TOTAL_PAGES,
  VideosPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  VideosPage.JSON_PROPERTY_ITEMS
})
...
public class VideosPage {
  ...
  public VideosPage items(@javax.annotation.Nonnull List<Video> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<Video> items) {
    this.items = items;
  }
