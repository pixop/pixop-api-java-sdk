...
/**
 * Represents the payload for creating a new video processing configuration. This includes the configuration’s name, processing options, and an optional description. 
 */
@JsonPropertyOrder({
