 ...
 */
@JsonPropertyOrder({
  WebhooksPage.JSON_PROPERTY_PAGE_NUMBER,
  WebhooksPage.JSON_PROPERTY_PAGE_SIZE,
  WebhooksPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  WebhooksPage.JSON_PROPERTY_TOTAL_PAGES,
  WebhooksPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  WebhooksPage.JSON_PROPERTY_ITEMS
})
...
public class WebhooksPage {
  ...
  public WebhooksPage items(@javax.annotation.Nonnull List<Webhook> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<Webhook> items) {
    this.items = items;
  }
