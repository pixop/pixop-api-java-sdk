 ...
 */
@JsonPropertyOrder({
  S3OutputLocationsPage.JSON_PROPERTY_PAGE_NUMBER,
  S3OutputLocationsPage.JSON_PROPERTY_PAGE_SIZE,
  S3OutputLocationsPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  S3OutputLocationsPage.JSON_PROPERTY_TOTAL_PAGES,
  S3OutputLocationsPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  S3OutputLocationsPage.JSON_PROPERTY_ITEMS
})
...
public class S3OutputLocationsPage {
  ...
  public S3OutputLocationsPage items(@javax.annotation.Nonnull List<S3OutputLocation> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<S3OutputLocation> items) {
    this.items = items;
  }
