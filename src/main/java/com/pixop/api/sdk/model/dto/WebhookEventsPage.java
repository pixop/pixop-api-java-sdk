 ...
 */
@JsonPropertyOrder({
  WebhookEventsPage.JSON_PROPERTY_PAGE_NUMBER,
  WebhookEventsPage.JSON_PROPERTY_PAGE_SIZE,
  WebhookEventsPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  WebhookEventsPage.JSON_PROPERTY_TOTAL_PAGES,
  WebhookEventsPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  WebhookEventsPage.JSON_PROPERTY_ITEMS
})
...
public class WebhookEventsPage {
  ...
  public WebhookEventsPage items(@javax.annotation.Nonnull List<WebhookEvent> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<WebhookEvent> items) {
    this.items = items;
  }
