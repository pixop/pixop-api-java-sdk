 ...
 */
@JsonPropertyOrder({
  WebhookPost.JSON_PROPERTY_NAME,
  WebhookPost.JSON_PROPERTY_DESCRIPTION,
  WebhookPost.JSON_PROPERTY_URL,
  WebhookPost.JSON_PROPERTY_RATE_LIMIT_PER_SECOND,
  WebhookPost.JSON_PROPERTY_MAX_TOTAL_RETRY_DELAY_MINUTES,
  WebhookPost.JSON_PROPERTY_EVENT_TYPES,
  WebhookPost.JSON_PROPERTY_ACTIVE
})
...
public class WebhookPost {
  ...
  public WebhookPost eventTypes(@javax.annotation.Nonnull List<WebhookEventType> eventTypes) {
