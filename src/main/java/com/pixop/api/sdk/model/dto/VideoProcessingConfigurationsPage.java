 ...
 */
@JsonPropertyOrder({
  VideoProcessingConfigurationsPage.JSON_PROPERTY_PAGE_NUMBER,
  VideoProcessingConfigurationsPage.JSON_PROPERTY_PAGE_SIZE,
  VideoProcessingConfigurationsPage.JSON_PROPERTY_NUMBER_OF_ELEMENTS,
  VideoProcessingConfigurationsPage.JSON_PROPERTY_TOTAL_PAGES,
  VideoProcessingConfigurationsPage.JSON_PROPERTY_TOTAL_ELEMENTS,
  VideoProcessingConfigurationsPage.JSON_PROPERTY_ITEMS
})
...
public class VideoProcessingConfigurationsPage {
  ...
  public VideoProcessingConfigurationsPage items(@javax.annotation.Nonnull List<VideoProcessingConfiguration> items) {
  ...
  @JsonProperty(JSON_PROPERTY_ITEMS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setItems(@javax.annotation.Nonnull List<VideoProcessingConfiguration> items) {
    this.items = items;
  }
