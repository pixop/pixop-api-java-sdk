 ...
 */
@JsonPropertyOrder({
  VideoProcessingJobAppraisal.JSON_PROPERTY_BILLING_TYPE,
...
@JsonSubTypes({
  @JsonSubTypes.Type(value = VideoProcessingJobAppraisalPixopCredits.class, name = "AWS_MARKETPLACE"),
  @JsonSubTypes.Type(value = VideoProcessingJobAppraisalUsd.class, name = "STRIPE"),
})
...
public class VideoProcessingJobAppraisal {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.billingType, videoProcessingJobAppraisal.billingType) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(billingType, estimation, outputDurationMillis);
  }
