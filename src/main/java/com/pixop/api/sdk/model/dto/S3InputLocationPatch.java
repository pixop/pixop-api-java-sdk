 ...
 */
@JsonPropertyOrder({
  S3InputLocationPatch.JSON_PROPERTY_BUCKET,
  S3InputLocationPatch.JSON_PROPERTY_ACCESS_KEY,
  S3InputLocationPatch.JSON_PROPERTY_SECRET_ACCESS_KEY,
  S3InputLocationPatch.JSON_PROPERTY_NAME
})
