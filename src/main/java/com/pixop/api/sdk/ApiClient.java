...
import com.pixop.api.sdk.auth.Authentication;
import com.pixop.api.sdk.auth.HttpBasicAuth;
import com.pixop.api.sdk.auth.HttpBearerAuth;
import com.pixop.api.sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.pixop.com/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.pixop.com/api",
      "Production environment",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
      "https://staging-api.pixop.com/api",
      "Staging environment",
      new HashMap<String, ServerVariable>()
    )
  ));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/1.0.0-rc.1/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.pixop.com/api
     ...
     * @return a {@link com.pixop.api.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.pixop.api.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.pixop.api.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws com.pixop.api.sdk.ApiException If fail to serialize the request body object into a string
     */
